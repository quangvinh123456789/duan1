...
<body>
    ...
    <form style="margin-top: 20px; width: 60%; margin-left: 350px;" action="?act=dangky" method="post" >
        <h2 style="text-align: center; margin-top: 50px;">Đăng ký</h2>
        <!--  -->
        <div data-mdb-input-init class="form-outline mb-4">
            <label class="form-label" for="form2Example2">Tên đăng nhập</label>
            <input type="text" id="form2Example2" class="form-control" name="user" /><?= (isset($error['user'])) ?  $error['user'] : '' ?>
        </div>
        <!-- Email input -->
        <div data-mdb-input-init class="form-outline mb-4">
            <label class="form-label" for="form2Example1">Email</label>
            <input type="email" id="form2Example1" class="form-control" name="email" /><?= (isset($error['email'])) ?  $error['email']  : '' ?>
        </div>

        <!-- Password input -->
        <div data-mdb-input-init class="form-outline mb-4">
            <label class="form-label" for="form2Example2">Mật khẩu</label>
            <input type="password" id="form2Example2" class="form-control" name="pass" /><?= (isset($error['pass'])) ?  $error['pass']  : '' ?>
        </div>
        <!--  -->
        <div data-mdb-input-init class="form-outline mb-4">
            <label class="form-label" for="form2Example2">Nhập lại Mật khẩu</label>
            <input type="password" id="form2Example2" class="form-control" name="confirmPass" /><?= (isset($error['confirmPass'])) ?  $error['confirmPass']  : '' ?>
        </div>
        <div class="forget mt">
            <label><input type="checkbox"> Ghi nhớ mật khẩu</label>
        </div>
        <div data-mdb-input-init class="form-outline mb-4">
            <button name="btn"  type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block mb-4" value="dangky">Đăng ký</button></a>
