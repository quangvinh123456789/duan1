...
>>>>>>> 265f23ffb671ea47d1fa75c5572033c037787f27:front_end/about.php
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="about__pic">
                        <img src="img2/minhchung.webp" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Chúng tôi là ai?</h4>
                        <p>Trong thế hệ kỹ thuật số này, nơi thông tin có thể dễ dàng có được trong vòng vài giây, doanh nghiệpthẻ vẫn giữ được tầm quan trọng của chúng.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Tại sao chọn chúng tôi</h4>
                        <p>Một ngôi nhà hai hoặc ba tầng là cách lý tưởng để tận dụng tối đa mảnh đất mà ngôi nhà của chúng ta dựa vào.
                            Ngồi, nhưng dành cho người già hoặc người ốm yếu.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-6 p-0">
                    <div class="testimonial__text">
                        ...
                        <p>"Nhìn vào đồng hồ, bạn sẽ thấy thời gian; nhưng cảm nhận nó, bạn sẽ thấy giá trị cuộc sống."
                        </p>
                        <div class="testimonial__author">
                            <div class="testimonial__author__pic">
                                <img src="img2/tacgia.jpg" alt="">
                            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter__item">
                        ...
                        <span>Vui mừng <br />Khách hàng                        </span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu2.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu3.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu4.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu5.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu6.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu7.webp" alt=""></a>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-4 col-6">
                    <a href="#" class="client__item"><img src="img2/thuonghieu8.webp" alt=""></a>
                </div>
            </div>
        </div>
    </section>
